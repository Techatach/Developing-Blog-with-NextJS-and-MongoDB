  ...
  return (
    <header className="cursor-pointer container mx-auto px-5 flex justify-between py-4 items-center z-50">
      <div>
        <Link
          href={"/"}
          className="text-primary text-3xl font-bold hover:bg-primary p-2 border-md hover:text-white transition-all duration-300"
        >
          Blog Site
        </Link>
      </div>
      ...
      >
        <ul className="z-50 gap-y-5 items-center flex gap-x-5 flex flex-col lg:flex-row font-semibold gap-x-2">
          <li>
            <Link
              className="text-orange-300 text-2xl font-bold hover:bg-orange-700 p-2 border-md hover:text-white transition-all duration-300"
              href={"/"}
            >
              Home
            </Link>
